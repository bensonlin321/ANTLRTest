...
create
    : CREATE fileIdentifier columnNames
    ;

insert
    : INSERT INTO fileIdentifier columnNames ROWS values (COMMA values)*
    ;
...
select
    : SELECT expressionList FROM fileIdentifier (WHERE booleanExpression)?
    ;
